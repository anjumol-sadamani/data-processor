...
class TrimDescriptionRuleTest {
    ...
    void apply() {
        ...
        assertEquals(250,actualArticle.getDescription().length());
    }

    String longText = "Far far away, behind the word mountains, far from the countries Vokalia and Consonantia," +
            ...
            "of Grammar. The Big Oxmox advised her not to do so, because there were thousands of bad Commas, wild" +
            ...
            "question ran over her cheek, then she continued her way. On her way she met a copy. The copy warned the" +
            " Little Blind Text, that where it came from it would have been rewritten a thousand times and everything" +
            " that was left from its origin would be the word \"and\" and the Little Blind Text should turn";
}